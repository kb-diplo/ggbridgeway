<?php
// InfinityFree Database Configuration for Githunguri Bridgeway School
// Copy this content to includes/config.php when deploying to InfinityFree

// Database configuration for InfinityFree
define('DB_HOST', 'sql206.infinityfree.com');
define('DB_NAME', 'if0_40322936_bridgeway_school');
define('DB_USER', 'if0_40322936');
define('DB_PASS', 'B1ljovew');
...
// Security settings for production (InfinityFree supports HTTPS)
ini_set('session.cookie_httponly', 1);
ini_set('session.use_only_cookies', 1);
ini_set('session.cookie_secure', 1); // HTTPS enabled on InfinityFree
...
// Database connection using PDO with production error handling
try {
...
// Production error reporting (hide errors from users, log them instead)
